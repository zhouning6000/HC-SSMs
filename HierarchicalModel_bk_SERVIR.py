...
class HierarchicalModel(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.high_level = MambaNet(model_dim=input_dim,nlayers=6)
    ...
    def forward(self, x, has_mask=True):
        ...
        #output=self.conv1x1(output.reshape(5,512,8,8))# taxiing
        output = self.conv1x1(output.reshape(1, 8, 48, 48))
        #output=output.reshape(-1,12 ,512 ,8,8)#Taxibj
        output = output.reshape(-1, 10, 8, 48, 48)  # Taxibj
        return output
